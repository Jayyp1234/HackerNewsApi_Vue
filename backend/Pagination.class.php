...
class Pagination{
	...
	var $prevLink		= 'Prev';
	var $lastLink		= 'Last >';
	var $fullTagOpen	= '<ul class="pagination justify-content-center align-items-center justify-content-md-start">';
	var $fullTagClose	= '</ul>';
	var $firstTagOpen	= '';
	var $firstTagClose	= '';
	var $lastTagOpen	= '';
	var $lastTagClose	= '';
	var $curTagOpen		= '<li class="page-item" ><a class="page-link" style="background-color: #6576ff;pointer-events: none;color: white;" disabled href="#">';
